...
Click __*release*__, then __*dosbox-x\_0.83.2-1-\<verion\>\_i386.deb*__ to download it.  When the download has completed you can install it by double-clicking it or entering `sudo dpkg dosbox-x_0.83.2-1-<version>_i386.deb` from a terminal.  
